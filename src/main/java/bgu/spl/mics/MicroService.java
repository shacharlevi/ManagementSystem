...
public abstract class MicroService implements Runnable {
 ...
 private Boolean terminated = false;
    ...
    private Map<Class<?> , Callback > callMap = new ConcurrentHashMap<>(); //<event,callback>

    //todo: can we use a bus field instead of calling MessageBusImpl.getInstance in every function
...
//                System.out.println(name+" get "+message.getClass());
                callMap.get( message.getClass()).call( message );
            }
